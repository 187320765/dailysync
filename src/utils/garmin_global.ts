...
const GARMIN_GLOBAL_USERNAME = "hei_bao@qq.com";//process.env.GARMIN_GLOBAL_USERNAME ?? GARMIN_GLOBAL_USERNAME_DEFAULT;
const GARMIN_GLOBAL_PASSWORD = "Jing123*";//process.env.GARMIN_GLOBAL_PASSWORD ?? GARMIN_GLOBAL_PASSWORD_DEFAULT;
...
const GARMIN_SYNC_NUM = 1038;//process.env.GARMIN_SYNC_NUM ?? GARMIN_SYNC_NUM_DEFAULT;
